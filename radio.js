document.addEventListener('DOMContentLoaded', () => {
    const songListUrl = '/kan_radio/songs.txt';
    let musicFiles = [];
    let songCounter = 0;
    let isPlaying = false;
    ...
    function playRandomSong() {
        ...
        const selectedSong = musicFiles[randomIndex].startsWith('/kan_radio/music/')
            ? musicFiles[randomIndex]
            : `/kan_radio/music/${musicFiles[randomIndex]}`;
    ...
    function playAnnouncement() {
        audioPlayer.src = '/kan_radio/announce/announce.mp3';
